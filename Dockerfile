...
ENV WILDFLY_MANAGEMENT_BIND_ADDRESS="0.0.0.0"
...
ENTRYPOINT /opt/keycloak/bin/standalone.sh -b=${KEYCLOAK_BIND_ADDRESS} -bmanagement=${WILDFLY_MANAGEMENT_BIND_ADDRESS}
